...
public class Play {
	...
	public String getPlay_imageName() {
		return play_imageName;
	}
	public void setPlay_imageName(String play_imageName) {
		this.play_imageName = play_imageName;
	}
	...
	public String toString() {
		return "Play [play_id=" + play_id + ", play_type_id=" + play_type_id + ", play_lang_id=" + play_lang_id
				+ ", play_name=" + play_name + ", play_introduction=" + play_introduction + ", play_imageUrl="
				+ play_imageUrl + ", play_imageName=" + play_imageName + ", play_length=" + play_length
